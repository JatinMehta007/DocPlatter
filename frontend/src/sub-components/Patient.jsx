  ...
  return (
    <div className="min-h-screen overflow-hidden">
      {!showMeal && ( 
        <div>
          <div>
            <p className="md:text-4xl text-xl md:m-8 m-2 text-gray-300 font-semibold font-sans tracking-wide">
              Patient Names
            </p>
    ...
    >
      Add Record
            ...
            patients.map((patient,index) => {
              ...
              <div
                ...
                >
                  <div className="xl:group-hover:bg-yellow-600 bg-yellow-600 lg:bg-zinc-600 w-[10px] h-14 pl-0"></div>
                  <div className="w-full flex flex-row">
                    ...
                    <p className="xl:ml-20  ml-1  text-zinc-400 md:p-2 p-1 font-semibold text-xs h-14 md:text-sm bg-gradient-to-l from-zinc-800 to-zinc-950 cursor-pointer hover:text-white">
      ...
      {showMeal && ( 
        ...
        <div className="p-4">
          <button onClick={handleBack} className="  md:w-52 w-8 bg-yellow-600 text-white rounded hover:bg-yellow-700 font-bold flex justify-center items-center ">
            <span className="text-lg font-bold">←</span> <span className="md:block md:invisible hidden">d</span><span className="hidden md:flex">Back to Patient List</span>
          </button>
        </div>
